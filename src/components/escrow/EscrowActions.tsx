...
export function EscrowActions({
  ...
  // Styles communs pour les boutons sur mobile et desktop
  const primaryButtonClass = "w-full font-medium h-auto py-5 rounded-md";
  const outlineButtonClass = "w-full border-gray-300 text-gray-700 h-auto py-5 rounded-md";
          ...
          <DialogContent className="max-w-[350px] rounded-lg">
            ...
            <div className="flex flex-col space-y-4">
              <div className="space-y-1">
                ...
                <Select>
                  <SelectTrigger id="issue-type" className="rounded-md">
              ...
              <div className="space-y-1">
                ...
                <Textarea id="description" placeholder="Décrivez le problème en détail..." className="rounded-md" />
              </div>

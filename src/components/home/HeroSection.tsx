...
export function HeroSection() {
  return (
    <div className="relative bg-gradient-to-br from-purple-100 to-purple-50 overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-orange-500/10 backdrop-blur-[1px]" />
      </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/search">
              <Button 
                variant="outline" 
                size="lg" 
                className="group text-lg h-14 px-8 border-2 hover:bg-primary/5"
              >
      ...
      <div className="absolute top-0 right-0 w-48 h-48 bg-primary/20 rounded-full transform translate-x-20 -translate-y-20 blur-3xl" />
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-secondary/20 rounded-full transform -translate-x-32 translate-y-32 blur-3xl" />
    </div>
  );
}
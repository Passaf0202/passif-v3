        ...
        <div className="md:grid md:grid-cols-2 gap-8 md:gap-6 lg:gap-8 xl:gap-12">
          <div className="flex flex-col items-center gap-6 md:hidden">
            <motion.div 
              ...
              className="space-y-4 sm:space-y-6 w-full flex flex-col items-center"
            >
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 leading-tight text-center">
          ...
          <motion.div 
            ...
            transition={{ duration: 0.5 }}
            className="hidden md:flex md:order-1 space-y-4 sm:space-y-6 flex-col items-start"
          >
            <motion.div 
              initial={{ opacity: 0, x: -20 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.5 }}
              className="space-y-4 sm:space-y-6 w-full flex flex-col items-center md:order-1 w-full flex flex-col items-center md:items-start"
            >
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.2 }}
            className="hidden md:flex justify-center items-center md:order-2"
          >

          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-fit">
              <Link to="/create">
                <Button 
                  size="default"
                  className="h-10 px-4 text-sm bg-primary hover:bg-primary/90 rounded-[25px] whitespace-nowrap group"
                >
              ...
              <Link to="/search">
                <Button 
                  variant="outline" 
                  size="default"
                  className="h-10 px-4 text-sm bg-white text-primary hover:text-primary hover:bg-gray-50 rounded-[25px] border-2 border-primary whitespace-nowrap group"
                >
                  <img 
                    src="https://khqmoyqakgwdqixnsxzl.supabase.co/storage/v1/object/public/logos//Logo%20Tradecoiner%20(1).svg" 
                    alt="Tradecoiner"

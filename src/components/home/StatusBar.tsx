    ...
    <div className="absolute top-0 left-0 right-0 h-[44px] px-8 flex items-center justify-between z-50">
      ...
      <div className="flex items-center translate-y-[1px] mr-[-10px]">
        <svg width="18" height="12" viewBox="0 0 18 12" fill="none" className="scale-[0.6]">
          <rect x="11" y="1" width="2" height="9" rx="0.7" className="pure-black-fill"/>
          <rect x="7.5" y="3" width="2" height="7" rx="0.7" className="pure-black-fill"/>
          <rect x="4" y="5" width="2" height="5" rx="0.7" className="pure-black-fill"/>
          <rect x="0.5" y="7" width="2" height="3" rx="0.7" className="pure-black-fill"/>
        </svg>

        <span className="text-[6.5px] font-semibold pure-black-text translate-y-[0px] ml-[-2px]">5G</span>

        <div className="relative h-[13px] w-[24px] translate-y-[0px] ml-[-2px]">

    ...
    <div className="absolute top-0 left-0 right-0 h-[44px] px-8 flex items-center justify-between z-50">
      ...
      <div className="flex items-center gap-[1px] translate-y-[1px] mr-[-8px]">
        <svg width="18" height="12" viewBox="0 0 18 12" fill="none" className="scale-[0.65]">
          ...
          <rect x="10.5" y="3" width="2" height="7" rx="0.7" className="pure-black-fill"/>
          <rect x="7" y="5" width="2" height="5" rx="0.7" className="pure-black-fill"/>
          <rect x="3.5" y="7" width="2" height="3" rx="0.7" className="pure-black-fill"/>
          <rect x="0" y="9" width="2" height="1" rx="0.5" className="pure-black-fill"/>
        </svg>

        <span className="text-[6.5px] font-semibold pure-black-text translate-y-[0px] ml-[1px]">5G</span>
